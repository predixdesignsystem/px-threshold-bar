...
function runBaseTests() {
  ev_threshold_bar_1 = document.getElementById('ev_threshold_bar_1');

  suite('Base Automation Tests for ev-threshold-bar', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('ev-threshold-bar fixture is created', function() {
      assert.isTrue(document.getElementById('ev_threshold_bar_1') !== null);
    });
